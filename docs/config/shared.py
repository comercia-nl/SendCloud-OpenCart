...
# -*- coding: utf-8 -*-
#
# SendCloud OpenCart 2 Extension documentation build configuration file, created by
...
#NOTE: To generate PDF's you need to use Python 2 since rst2pdf is not Py3 compatible.

import sys
import os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../')))
from helper import RELEASE_VERSION, EXTENSION_VERSION
...
html_static_path = ['../static', 'static'] #Shared static + langspecific static
...
htmlhelp_basename = 'SendCloudOpenCart2doc'
