...
build-extension:
	...
	curl https://raw.githubusercontent.com/SendCloud/SendCloud-API-PHP-Wrapper/a40dfd55acfea2d33301169c63d59c82a68b47f4/src/SendCloudApi.php > "$(BUILD_SENDCLOUD_ROOT)/sendcloud_api.php"
